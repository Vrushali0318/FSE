...
set _DeploySetParametersFile=%RootPath%SPA_MVC_StudentInfo.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%SPA_MVC_StudentInfo.zip" (
echo "%RootPath%SPA_MVC_StudentInfo.zip" does not exist. 
...
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%SPA_MVC_StudentInfo.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%SPA_MVC_StudentInfo.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
) else (
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%SPA_MVC_StudentInfo.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%SPA_MVC_StudentInfo.SetParameters.xml" %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%SPA_MVC_StudentInfo.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%SPA_MVC_StudentInfo.SetParameters.xml" %_MsDeployAdditionalFlags%
)
goto :eof
...
:usage
echo =========================================================
if not exist "%RootPath%SPA_MVC_StudentInfo.deploy-readme.txt" (
...
start notepad "%RootPath%SPA_MVC_StudentInfo.deploy-readme.txt"
)
echo =========================================================
goto :eof
